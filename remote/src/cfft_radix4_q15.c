 ...
 * Title:        cfft_radix4_q15.c
 * Description:  Radix-4 FFT & IFFT function
 *
...
/* Define ARM_DSP_ATTRIBUTE as empty for PC compilation */
...
/* Old wrapper function - not needed for simplified version
